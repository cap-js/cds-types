...
export class ConstructedQuery {
    ...
    then (_resolved: (x: unknown) => unknown, _rejected: (e: Error) => unknown): unknown
...
type QLExtensions<T> = T extends QLExtensions_<unknown> ? T : QLExtensions_<T>
...
// composition of many/ association to many
	 ...
	 */
        (fn: ((a: QLExtensions<T[number]>) => unknown) | '*'): T[number];
    }
...
export type StaticSELECT<T> = typeof SELECT
  & ((...columns: (T extends ArrayConstructable<unknown> ? keyof SingularType<T> : keyof T)[]) => SELECT<T>)
...
declare class QL<T> {
    ...
    & ((...entries: object[]) => INSERT<unknown>) & ((entries: object[]) => INSERT<unknown>)

    UPSERT: typeof UPSERT
    & ((...entries: object[]) => UPSERT<unknown>) & ((entries: object[]) => UPSERT<unknown>)
...
export class SELECT<T> extends ConstructedQuery {
    ...
    & ((...col: (T extends ArrayConstructable<unknown> ? keyof SingularType<T> : keyof T)[]) => this)
...
&
// calling with class
  (<T extends ArrayConstructable<unknown>>
...
&
  ...
  & ((entity: Definition | string, primaryKey?: PK, projection?: Projection<unknown>) => SELECT<unknown>)
  & ((entity: LinkedEntity | string, primaryKey?: PK, projection?: Projection<unknown>) => SELECT<unknown>)
...
export class INSERT<T> extends ConstructedQuery {
    ...
    static into: (<T extends ArrayConstructable<unknown>> (entity: T, entries?: object | object[]) => INSERT<SingularType<T>>)
      & (TaggedTemplateQueryPart<INSERT<unknown>>)
      & ((entity: Definition | string, entries?: object | object[]) => INSERT<unknown>)
      & ((entity: LinkedEntity | string, entries?: object | object[]) => INSERT<unknown>)
    ...
    columns (...col: (T extends ArrayConstructable<unknown> ? keyof SingularType<T> : keyof T)[]): this
    columns (...col: string[]): this
    values (...val: unknown[]): this
    rows (...row: unknown[]): this
...
export class UPSERT<T> extends ConstructedQuery {
    ...
    static into: (<T extends ArrayConstructable<unknown>> (entity: T, entries?: object | object[]) => UPSERT<SingularType<T>>)
      & (TaggedTemplateQueryPart<UPSERT<unknown>>)
      & ((entity: Definition | string, entries?: object | object[]) => UPSERT<unknown>)
      & ((entity: LinkedEntity | string, entries?: object | object[]) => UPSERT<unknown>)
...
export class UPDATE<T> extends ConstructedQuery {
    ...
    // cds-typer plural
    static entity<T extends ArrayConstructable<unknown>> (entity: T, primaryKey?: PK): UPDATE<SingularType<T>>

    static entity (entity: Definition | string, primaryKey?: PK): UPDATE<unknown>
    static entity (entity: LinkedEntity | string, primaryKey?: PK): UPDATE<unknown>
...
export class CREATE<T> extends ConstructedQuery {
    ...
    static entity (entity: LinkedEntity | string): CREATE<unknown>
...
export class DROP<T> extends ConstructedQuery {
    ...
    static entity (entity: LinkedEntity | string): DROP<unknown>
    DROP: CQN.DROP['DROP']
